        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredProjects.map((project) => {
            ...
            return (
              <div
                key={project.id}
                className="group flex flex-col justify-between bg-neutral-950/80 border border-neutral-800 hover:border-amber-400/50 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10"
              >
                <div>
                  {/* Project Image */}
                  {project.image && (
